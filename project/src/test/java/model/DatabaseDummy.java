...
public class DatabaseDummy {
	...
	try {
		...
		String instance = ConfigTest.get("cloudSqlInstance");
		String database = ConfigTest.get("cloudSqlDatabase");
		String username = ConfigTest.get("cloudSqlUsername");
		String password = ConfigTest.get("cloudSqlPassword");
		...
		String database = ConfigTest.get("localSqlDatabase");
		String username = ConfigTest.get("localSqlUsername");
		String password = ConfigTest.get("localSqlPassword");
