insert ignore into `vehicles`
	(`registration`, `make`, `model`, `year`, `colour`, `location`, `status`)
values
    ("ABC123","Toyota", "Corolla", 2014, "Blue", POINT(-37.808401, 144.956159), 1),
    ("QRB990","BMW", "325i", 2003, "Black", POINT(-37.809741, 144.970895), 1),
    ("TAA325","Peugeot", "307 SW", 2008, "Grey", POINT(-37.805819, 144.960025), 1),
    ("UBR666","Ford", "Falcon", 2013, "Orange", POINT(-37.815603, 144.969967), 1),
    ("FOK356","Holden", "Barina", 2017, "White", POINT(-37.814022, 144.961954), 0),
    ("JTD955","Holden", "Commadore", 2005, "Grey", POINT(-37.816170, 144.956179), 0),
    ("BLA555","Mazda", "3", 2010, "White", POINT(-37.818681, 144.958982), 0),
    ("QOP299","Kia", "Rio", 2013, "Pink", POINT(-37.811510, 144.965667), 0),
    ("YODUDE","Nissan", "Skyline", 2010, "Black", POINT(-37.810422, 144.968597), 0),
    ("MAGPIES", "Mercedes-Benz", "CLC200 Kompressor", 2009, "Black", POINT(-37.807232, 144.963620), 0),
    ("HEL111", "Holden", "Astra", 2014, "Black", POINT(-37.801111, 144.973397), 0);
